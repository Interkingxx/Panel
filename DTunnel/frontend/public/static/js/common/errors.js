class InternalError {
    ...
    render() {
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <h3 class="text-dark">Algo salio mal!</h3>
...
class NotFoundError {
    ...
    render() {
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <h3 class="text-dark">Pagina no encontrada!</h3>
...
class UnauthorizedError {
    ...
    render() {
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <h3 class="text-dark">Usted no tiene Permiso para ingresar a esta página!</h3>
            <a href="/logout" class="btn btn-dark rounded-pill">&larr; VOLVER</a>
        </div>`;
        this.element.innerHTML = html;
    }
