...
export class ConfigType extends SelectFiled {
    constructor(types) {
        ...
        this._label.innerText = 'Modo de conexiones'
    }
}
...
export class ConfigCategory extends SelectFiled {
    constructor(categories) {
        ...
        this._label.innerText = 'Categorias'
    }
}
...
export class ConfigTlsVersion extends SelectFiled {
    constructor(versions) {
        ...
        this._label.innerHTML = 'Version del TLS'
    }
}
...
export class ConfigName extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Define un NOMBRE para la Configuración')
        }
    }
}
...
export class ConfigPayload extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina su PAYLOAD para la configuración')
        }
    }
}
...
export class ConfigOpenVPN extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina el certificado OpenVPN para la configuracion')
        }
    }
}
...
export class ConfigV2ray extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Configuracion v2ray inválida!')
        }
    }
}
...
export class ConfigServer extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina uma SERVIDOR para la configuracion')
        }
    }
}
...
export class ConfigPort extends NumberFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina un PUERTO para la configuracion')
        }
    }
}
