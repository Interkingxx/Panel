...
class ConfigExportFile {
    async export(data) {
        ...
        showToastSuccess('Opa! configuración exportada exitosamente!');;
    }
}
...
class ConfigExportUrl {
    async export(data) {
        ...
        try {
            ...
            showToastSuccess('Exito! Configuración exportada exitosamente!');
            return result.data;
        } catch (e) {
...
class ConfigExportApp {
    ...
    validate(data) {
        ...
        if (Array.isArray(config)) {
            showToastError('Lo sentimos no es posible exportar múltiples configuraciones para su  app!');
            return false;
        }
        return true;
    }
