...
export const AppLayoutDefault = [
  ...
  {
    label: 'Color de fondo de diálogos',
  ...
  {
    label: 'Color de fondo del diálogo de log',
  ...
  {
    label: 'Actualizar automáticamente las configuraciones al hacer una actualización',
  ...
  {
    label: 'Usar botones de registro',
  ...
  {
    label: 'Activar toast de confirmación',
  ...
  {
    label: 'LAYOUT WEBVIEW (POR SU CUENTA Y PROPIO RIESGO)',
  ...
  {
    label: 'ANDROID WEBVIEW (POR SU CUENTA Y PROPIO RIESGO)',
  ...
  {
    label: 'PÁGINA WEBVIEW (POR SU CUENTA Y PROPIO RIESGO)',
    name: 'APP_WEB_VIEW',
    status: 'ACTIVE',
    type: 'HTML',
    value: null,
